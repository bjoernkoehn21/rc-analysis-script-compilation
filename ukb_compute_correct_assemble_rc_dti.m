...
% adapt line of total intrakranial volume: tivLineNumber
...
SUBJ_ID_FILE = 'ukb_subjIDs.txt';
PATH_TO_SUBJ_DIRS = '/slow/projects/01_UKB/dti/00_batch1';
...
function hcp_compute_correct_rc_dti(iSubj, subjID, nRandomNetworks, edge, files, RCResults, RCdense, tivLineNumber)
    ...
    resultsDir = fullfile(PATH_TO_SUBJ_DIRS, subjID, 'DWI_processed_v311');
    cd(resultsDir);
